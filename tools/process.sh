...
echo "[Click here for dataset info](https://github.com/0x4248/opensky/blob/master/dataset/$set_number/info.json)" >> $location/README.md
echo "## Photos preview" >> $location/README.md

echo "<img src=\"https://raw.githubusercontent.com/0x4248/opensky/master/dataset/$set_number/photos.gif\" width=\"200px\"/>" >> $location/README.md
echo "<img src=\"https://raw.githubusercontent.com/0x4248/opensky/master/dataset/$set_number/photos_bw.gif\" width=\"200px\"/>" >> $location/README.md
